...
echo try { >> "%~dp0vmware-tools-removal.ps1"
echo     $additionalDrivers = Get-ChildItem $driversPath ^| Where-Object { $_.VersionInfo.CompanyName -eq "VMware, Inc." -or $_VersionInfo.CompanyName -eq "Broadcom Inc." } >> "%~dp0vmware-tools-removal.ps1"
