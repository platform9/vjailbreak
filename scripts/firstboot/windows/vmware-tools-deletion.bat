...
echo } >> "%~dp0vmware-tools-removal.ps1"
echo. >> "%~dp0vmware-tools-removal.ps1"
echo # Step 2: Delete VMware drivers from System32\drivers >> "%~dp0vmware-tools-removal.ps1"
echo Write-Log "Step 2: Removing VMware drivers from System32\drivers..." >> "%~dp0vmware-tools-removal.ps1"
echo. >> "%~dp0vmware-tools-removal.ps1"
echo Write-Log "Getting Files from C:\Windows\System32\drivers">> "%~dp0vmware-tools-removal.ps1"
echo Get-ChildItem -Path "C:\Windows\System32\drivers" ^| ForEach-Object { >> "%~dp0vmware-tools-removal.ps1"
echo     Write-Log "$($_)" >> "%~dp0vmware-tools-removal.ps1"
echo } >> "%~dp0vmware-tools-removal.ps1"
echo. >> "%~dp0vmware-tools-removal.ps1"
echo Write-Log "Getting Files from C:\Windows\Sysnative\drivers">> "%~dp0vmware-tools-removal.ps1"
echo Get-ChildItem -Path "C:\Windows\Sysnative\drivers" ^| ForEach-Object { >> "%~dp0vmware-tools-removal.ps1"
echo     Write-Log "$($_)" >> "%~dp0vmware-tools-removal.ps1"
echo } >> "%~dp0vmware-tools-removal.ps1"
echo. >> "%~dp0vmware-tools-removal.ps1"
