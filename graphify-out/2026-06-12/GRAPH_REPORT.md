...
## Corpus Check
- 736 files · ~1,736,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5762 nodes · 9527 edges · 752 communities (289 shown, 463 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 950 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34fb6b93`
...
8. `Migrate` - 55 edges
9. `Migrate` - 54 edges
10. `MigrationPlanReconciler` - 50 edges
...
## Communities (752 total, 463 thin omitted)
...
Cohesion: 0.13
Nodes (32): GPUInfo, GuestNicInfo, HostStorageDeviceInfo, GuestNetwork, HostSystem, ManagedObjectReference, Map, Mutex (+24 more)
...
Cohesion: 0.08
Nodes (119): BMProviderClient, BMProviderServer, serve(), ClientConn, DialOption, Handler, Message, Context (+111 more)
...
Cohesion: 0.19
Nodes (32): Host, Config, OpenStackCredsInfo, Client, Cluster, Context, OpenstackCreds, PCDCluster (+24 more)
...
Cohesion: 0.16
Nodes (25): controllerOwnerUID(), newRetryFixtures(), staleOwnerRef(), TestAdoptResource(), TestCreateFirstbootConfigMap_StaleOwnership(), TestCreateJob_OwnedJobUntouched(), TestCreateJob_StaleJobDeletedAndRequeued(), TestCreateMigrationConfigMap_RebuildsStaleConfigMapAfterRetry() (+17 more)
...
Cohesion: 0.17
Nodes (20): Flavor, OpenStackClients, OpenstackCreds, OpenstackInfo, ProviderClient, ServiceClient, buildBackendToVolumeTypeMap(), extractCinderHost() (+12 more)
...
## Knowledge Gaps
- **2173 isolated node(s):** `@emotion/react`, `@emotion/styled`, `@mui/icons-material`, `@mui/material`, `@mui/x-date-pickers` (+2168 more)
...
- **Why does `Contains()` connect `OpenStack Mock Recorder` to `vpwned Upgrade & Version`, `ESXi Migration Reconciler`, `MigrationPlan API Types`, `Keystone Auth (PCD)`, `Migration Credential Utils`, `OpenStack Client`, `PCD Auth & Keystone SDK`, `OpenStack Cinder Operations`, `RBAC Roles & CRD Docs`, `Monitoring Stack (Alertmanager)`, `VMwareMachine API Types`, `OpenStack Component`, `vpwned Update Response Protobuf`, `vpwned gRPC Server (Storage)`, `Community 292`, `RollingMigrationPlan API Types`, `Mock / Test Double`, `Community 303`, `CRD API Types`, `CRD API Types`, `CRD API Types`, `CRD API Types`, `Utilities`, `CRD API Types`, `CRD API Types`, `Protobuf Service`, `VMware Component`, `OpenStack Component`, `Component 80`, `Component 209`, `Protobuf Service`, `Component 229`, `Protobuf Service`, `Controller Component`, `Test Utilities`, `Test Utilities`, `Test Utilities`, `PCD Integration`?**
...
- **Why does `GetProvider()` connect `Component 60` to `Controller Component`, `NetApp Storage Provider`, `Controller Component`, `Rolling Migration Utils`, `VMware Component`?**
