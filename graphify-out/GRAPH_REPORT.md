...
## Corpus Check
- 738 files · ~1,742,460 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5368 nodes · 8452 edges · 793 communities (301 shown, 492 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 914 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b818ad8`
...
4. `Migrate` - 54 edges
5. `Context` - 49 edges
6. `MigrationPlanReconciler` - 46 edges
7. `Client` - 38 edges
8. `Context` - 37 edges
9. `Client` - 36 edges
10. `Info` - 34 edges
...
- `vJailbreak README` --references--> `Agents List (Post Scale Up) Screenshot`  [EXTRACTED]
  README.md → assets/scaleupagents.png

## Hyperedges (group relationships)
- **vJailbreak Core Go Modules** — module_controller, module_v2v_helper, module_vpwned, module_common [EXTRACTED 1.00]
- **Migration CRD Composition Chain** — crd_migrationplan, crd_migrationtemplate, crd_storagemapping, crd_networkmapping [EXTRACTED 1.00]
- **vJailbreak Open Source Dependencies** — virt_v2v, nbdkit, k3s, govmomi, virtio_win [EXTRACTED 1.00]
- **Credential CRDs Cluster** — crd_vmwarecreds, crd_openstackcreds, crd_esxisshcreds, crd_arraycreds, crd_bmconfig [INFERRED 0.95]
- **Migration Workflow CRDs** — crd_migration, crd_migrationplan, crd_migrationtemplate, crd_rollingmigrationplan, crd_clustermigration, crd_esximigration [EXTRACTED 0.95]
- **VMware Inventory CRDs** — crd_vmwarecluster, crd_vmwarehost, crd_vmwaremachine, crd_rdmdisk [INFERRED 0.90]
- **Complete VM Migration Workflow (migration.yaml bundle)** — vmwarecreds_pnapbmc1, openstackcreds_sapmo1, networkmapping_nwmap1, storagemapping_stmap1, migrationtemplate_migration_template_sample, migrationplan_vm_migration_sample [EXTRACTED 1.00]
...
## Communities (793 total, 492 thin omitted)

### Community 0 - "vpwned Upgrade & Version"
Cohesion: 0.06
Nodes (56): init(), runUpgradeJob(), DeploymentConfig, checkAndDeleteAllCustomResources(), checkAndDeleteMigrationPlans(), checkAndDeleteRollingMigrationPlans(), checkAndDeleteSecret(), checkAndScaleDownAgent() (+48 more)

### Community 1 - "ESXi Migration Reconciler"
Cohesion: 0.06
Nodes (55): computeSourceVMKey(), createVCenterClientAndDC(), extractVCenterCredentials(), getDatastoresForVolumeMapping(), GetVMwareMachineForVM(), MergeLabels(), resolveVirtioDriverURL(), TestGetDatastoresForVolumeMapping_FallsBackToLegacyDatastores() (+47 more)

### Community 2 - "MigrationPlan API Types"
Cohesion: 0.10
Nodes (41): Cmd, Context, GuestNetwork, IpEntry, VMDisk, DetectESPDiskIndex(), FirstBootWindows, VirtV2VOperations (+33 more)

### Community 3 - "K8s Utilities (Creds, Keys)"
Cohesion: 0.23
Nodes (14): ArrayInfo, BackendTarget, BackendTargetDiscoverer, BackendTargetGroup, CapacityInfo, MappingContext, OpenstackVolume, DeleteStorageProvider() (+6 more)

### Community 4 - "Keystone Auth (PCD)"
Cohesion: 0.09
Nodes (35): getVMKeyFromMigration(), MigrationReconciler, EventList, Client, Context, Manager, Migration, Request (+27 more)
...
Cohesion: 0.08
Nodes (22): CachedAuthenticator, OpenStackCredsInfo, Authenticator, NewBasicTokenGenerator(), NewCachedAuthenticator(), NewFileCachedAuthenticator(), NewSecretCachedAuthenticator(), NewStaticTokenAuthenticator() (+14 more)

### Community 9 - "OpenStack Client"
Cohesion: 0.11
Nodes (7): Client, NewClient(), NewClientWithTimeout(), Client, Context, Duration, Client
...
Cohesion: 0.07
Nodes (43): createDummyPCDCluster(), fetchAndUpdateFlavors(), generateArrayCredsName(), handlePCDSync(), handleValidatedCreds(), isRetryableUpdateError(), populateVMwareMachineFlavors(), runPCDSyncAsync() (+35 more)
...
Cohesion: 0.05
Nodes (52): AuthInfo, AuthRequest, AuthRequestAuth, AuthRequestAuthIdentity, AuthRequestAuthIdentityPassword, AuthRequestAuthIdentityPasswordUser, AuthRequestAuthScope, AuthRequestAuthScopeProject (+44 more)

### Community 16 - "BM Mock Provider"
Cohesion: 0.11
Nodes (15): targetVcenterGRPC, AccessInfo, Targets, DeleteTarget(), GetTarget(), GetTargets(), RegisterTarget(), VMInfo (+7 more)
...
Cohesion: 0.13
Nodes (33): GPUInfo, GuestNicInfo, HostStorageDeviceInfo, GuestNetwork, HostSystem, ManagedObjectReference, NIC, RDMDisk (+25 more)
...
Cohesion: 0.19
Nodes (33): Flavor, Client, Context, Flavor, OpenstackCreds, Node, NodeList, OpenstackCreds (+25 more)

### Community 24 - "VMwareMachine API Types"
Cohesion: 0.15
Nodes (41): BMCProvider, BMConfig, Client, Context, ESXIMigrationScope, LocalObjectReference, Migration, MigrationPlan (+33 more)

### Community 25 - "ESXi SSH Client"
Cohesion: 0.14
Nodes (15): RollingMigrationPlanReconciler, RollingMigrationPlanScope, PodPhase, CanEnterMaintenanceMode(), CheckClusterCapacityAfterHostRemoval(), CheckVMForMaintenanceMode(), CreateDefaultValidationConfigMapForRollingMigrationPlan(), GetMaintenanceModeOptions() (+7 more)

### Community 26 - "OpenStack Mock Operations"
Cohesion: 0.17
Nodes (21): local_request_BMProvider_DeployMachine_0(), local_request_BMProvider_GetResourceInfo_0(), local_request_BMProvider_ListBootSource_0(), local_request_BMProvider_ListMachines_0(), local_request_BMProvider_ReclaimBMHost_0(), local_request_BMProvider_SetResourceBM2PXEBoot_0(), local_request_BMProvider_SetResourcePower_0(), local_request_BMProvider_WhoAmI_0() (+13 more)

### Community 27 - "OpenstackCreds API Types"
Cohesion: 0.05
Nodes (35): ColonSeparated(), EqualWWNs(), FormattedWWPNFromFCUID(), ParseFCUID(), StripWWNFormatting(), TestColonSeparated(), TestColonSeparatedRoundTrip(), TestEqualWWNs() (+27 more)
...
Cohesion: 0.11
Nodes (29): DiskChangeExtent, File, Libnbd, BlockStatusData, handlePool, NBDOperations, coalesceExtents(), copyBlockParallel() (+21 more)

### Community 30 - "virt-v2v Mock Operations"
Cohesion: 0.18
Nodes (16): checkNetworkSubnetCompatibilityRequest, checkNetworkSubnetCompatibilityResponse, OpenStackClients, OpenstackCredsinfo, subnetCompatibilityResult, countValid(), CreateInClusterClient(), GetOpenStackClients() (+8 more)
...
Cohesion: 0.27
Nodes (17): Finder, VMwareCreds, VMwareCredsInfo, GetFinderForVMwareCreds(), GetVMwareCredentialsFromSecret(), GetVMwDatastore(), LogoutVMwareClient(), ValidateVMwareCreds() (+9 more)

### Community 33 - "vpwned gRPC Server (Storage)"
Cohesion: 0.07
Nodes (35): BaseOptionValue, Collector, isDiskEnableUUIDSet(), parseComponentCheckOutput(), ProxyVMReconciler, Datastore, Folder, Client (+27 more)
...
Cohesion: 0.22
Nodes (10): ArrayCredsMapping CRD, Controller Manager Cluster Admin Binding, Default Kustomization, Leader Election RoleBinding, Manager Kustomization, Manager Metrics Patch, Controller Manager Deployment, Controller Manager Metrics Service (+2 more)

### Community 36 - "NetApp Storage Provider"
Cohesion: 0.11
Nodes (44): ClusterMigration, ESXIMigration, Client, ClusterMigrationInfo, ClusterMigrationScope, ConfigMap, Context, ESXIMigrationScope (+36 more)

### Community 37 - "RollingMigrationPlan API Types"
Cohesion: 0.13
Nodes (15): description, items, type, id, properties, type, description, id (+7 more)
...
Cohesion: 0.17
Nodes (19): MigrationParams, MigrationParams, atoi(), DoRetryWithExponentialBackoff(), GetFirstbootConfigMapName(), GetInclusterClient(), GetMigrationConfigMapName(), GetMigrationObjectName() (+11 more)
...
Cohesion: 0.22
Nodes (10): getMostRecentValidationFailedCondition(), handleError(), updateStatusCondition(), ValidateRDMDiskFields(), RDMDiskReconciler, BuildVolumeManagePayload(), ExecuteVolumeManageRequest(), ImportLUNToCinder() (+2 more)
...
Cohesion: 0.22
Nodes (11): ESXIMigrationReconciler, BMConfig, Client, Context, ESXIMigrationScope, Manager, Request, Result (+3 more)

### Community 45 - "CRD API Types"
Cohesion: 0.31
Nodes (6): Cluster, HostConfig, Context, Request, Impl, Impl
...
Cohesion: 0.22
Nodes (14): assignHypervisor, bundle, Cluster, Config, Extensions, ExtensionsData, InterfaceAddress, InterfaceDetails (+6 more)

### Community 49 - "CRD API Types"
Cohesion: 0.11
Nodes (3): init(), PureStorageProvider, RegisterStorageProvider()
...
Cohesion: 0.05
Nodes (43): 10. Decisions (resolved) and remaining clarifications, 11. Suggested phasing & next steps, 12. Verified codebase references, 1. Overview, 2.1 Frontend (`ui/`), 2.2 Backend (`k8s/migration/`), 2. Where this lives in the codebase, 3. Terminology mapping (+35 more)
...
Cohesion: 0.05
Nodes (39): description, type, description, type, description, type, description, format (+31 more)
...
Cohesion: 0.07
Nodes (16): BootsourceSelections, Interface, IpmiType, NewMaasClient(), init(), MaasAccessInfo, MaasClient, MaasProvider (+8 more)
...
Cohesion: 0.29
Nodes (6): init(), BMAccessInfo, BMCProvider, DeleteProvider(), GetProviders(), RegisterProvider()
...
Cohesion: 0.14
Nodes (7): Extensions, Host, HTTPClient, Host, PrettyPrint(), GetOsRelease(), RunOfflineVMwareCleanup()
...
Cohesion: 0.28
Nodes (11): HostEntry, buildHostsLines(), BuildUserData(), isValidHostname(), ParseHostEntries(), SerializeHostEntries(), TestBuildUserData(), TestParseHostEntries() (+3 more)
...
Cohesion: 0.27
Nodes (3): parseESXiVersion(), ESXiSSHCredsReconciler, hostValidationResult

### Community 67 - "Controller Component"
Cohesion: 0.25
Nodes (11): HostConfig, OpenstackCreds, init(), OpenStackCredsInfo, OpenstackCredsList, OpenstackCredsSpec, OpenstackCredsStatus, OpenstackInfo (+3 more)
...
Cohesion: 0.17
Nodes (12): description, httpMethod, id, parameterOrder, path, response, scopes, response (+4 more)

### Community 70 - "CRD API Types"
Cohesion: 0.28
Nodes (11): ArrayCreds, init(), ArrayCredsInfo, ArrayCredsList, ArrayCredsSpec, ArrayCredsStatus, BackendTarget, BackendTargetGroup (+3 more)

### Community 72 - "Component 72"
Cohesion: 0.25
Nodes (14): TestCleanup_PartialVolumes_DeletesCreatedVolumeAndPorts(), TestCreateTargetInstance(), TestCreateTargetInstance_AdvancedMapping_InsufficientPorts(), TestCreateTargetInstance_AdvancedMapping_Ports(), TestCreateVolumes(), TestDeleteAllVolumes(), TestDeleteAllVolumes_SkipsNilOpenstackVol(), TestDetachAllVolumes() (+6 more)

### Community 73 - "Component 73"
Cohesion: 0.19
Nodes (9): GenerateXMLConfig(), Devices, Disk, Domain, Driver, Source, Target, GenerateXML() (+1 more)

### Community 74 - "Component 74"
Cohesion: 0.18
Nodes (16): init(), initCfg(), serve(), Handler, Marshaler, Context, Request, ResponseWriter (+8 more)

### Community 75 - "RBAC Manifests"
Cohesion: 0.30
Nodes (10): AdvancedOptions, MigrationPlan, init(), MigrationPlanList, MigrationPlanSpec, MigrationPlanSpecPerVM, MigrationPlanStatus, MigrationPlanStrategy (+2 more)

### Community 76 - "OpenStack Component"
Cohesion: 0.18
Nodes (27): ArrayCredsInfo, Client, Context, Flavor, OpenStackClients, OpenstackCreds, ServiceClient, OpenstackInfo (+19 more)

### Community 77 - "VMware Component"
Cohesion: 0.49
Nodes (8): PostValidationResources, authErrorMessage(), ensureLogger(), FetchResourcesPostValidation(), getCredentialsFromSecret(), Validate(), verifyCredentialsMatchCurrentEnvironment(), ValidationResult

### Community 78 - "Component 78"
Cohesion: 0.27
Nodes (9): OpenStackClients, OpenStackMetadata, CloudInitParams, Network, OpenStackMetadata, RollingMigartionValidationConfig, vmError, VMwareClusterInfo (+1 more)

### Community 79 - "VMware Component"
Cohesion: 0.15
Nodes (24): local_request_StorageArray_CreateOrUpdateInitiatorGroup_0(), local_request_StorageArray_GetMappedGroups_0(), local_request_StorageArray_MapVolumeToGroup_0(), local_request_StorageArray_ResolveCinderVolume_0(), local_request_StorageArray_UnmapVolumeFromGroup_0(), local_request_StorageArray_ValidateCredentials_0(), local_request_Version_Cleanup_0(), local_request_Version_GetAvailableTags_0() (+16 more)

### Community 80 - "Component 80"
Cohesion: 0.31
Nodes (9): FilterFlavorsByAvailabilityZone(), GetClosestFlavour(), getPassthroughGPUCount(), getVGPUCount(), isGPUFlavor(), TestFilterFlavorsByAvailabilityZone(), TestGetClosestFlavourWithGPU(), TestGetPassthroughGPUCount() (+1 more)

### Community 81 - "Component 81"
Cohesion: 0.31
Nodes (8): reprovisionTestScheme(), TestReconcileReprovision_NoAnnotation(), TestReconcileReprovision_RequestedIdleNode(), TestReconcileReprovision_RequestedWithActiveMigrations(), TestReprovisionAllowed_NilMigrations(), TestReprovisionAllowed_NoMigrations(), TestReprovisionAllowed_WithActiveMigrations(), reprovisionAllowed()

### Community 82 - "VMware Component"
Cohesion: 0.42
Nodes (3): VjailbreakNodeReconciler, DeleteNodeByName(), GetOpenstackVMByName()

### Community 83 - "Protobuf Service"
Cohesion: 0.27
Nodes (8): GetManager(), main(), SetupControllers(), Config, Config, Manager, Server, Server
...
Cohesion: 0.33
Nodes (9): ClusterMapping, ClusterMigrationInfo, RollingMigrationPlan, init(), RollingMigrationPlanList, RollingMigrationPlanPhase, RollingMigrationPlanSpec, RollingMigrationPlanStatus (+1 more)

### Community 86 - "Protobuf Service"
Cohesion: 0.29
Nodes (10): DeleteDependantObjectsForVMwareCreds(), DeleteVMwareClustersForVMwareCreds(), DeleteVMwarecredsSecret(), DeleteVMwareHostsForVMwareCreds(), DeleteVMwareMachinesForVMwareCreds(), FilterVMwareClustersForCreds(), FilterVMwareMachinesForCreds(), VMwareClusterList (+2 more)

### Community 87 - "Protobuf Service"
Cohesion: 0.32
Nodes (7): NewTestClient(), TestGetEndpointForRegion(), TestGetServiceID(), RoundTripFunc, Assert(), Equals(), Ok()

### Community 88 - "Controller Component"
Cohesion: 0.09
Nodes (26): description, id, location, pattern, properties, required, type, description (+18 more)

### Community 89 - "Component 89"
Cohesion: 0.46
Nodes (11): Client, Context, cleanupSimulator(), simulateVCenter(), TestDeleteSnapshot(), TestEnableCBT(), TestGetSnapshot(), TestGetVMInfo() (+3 more)

### Community 90 - "Component 90"
Cohesion: 0.10
Nodes (29): ArrayCredsMapping, atoi(), GetArrayCreds(), GetArrayCredsMapping(), GetESXiSSHPrivateKey(), GetHotAddPrivateKey(), GetInclusterClient(), GetRDMDisk() (+21 more)

### Community 91 - "Utilities"
Cohesion: 0.15
Nodes (16): GuestNetwork, NIC, RDMDisk, VirtualDisk, VMDisk, Volume, VirtualMachinePowerState, ChangeID (+8 more)
...
Cohesion: 0.51
Nodes (9): HostEntry, GetAgentHostEntries(), configMapWithHostEntries(), TestGetAgentHostEntries_ConfigMapMissing(), TestGetAgentHostEntries_KeyAbsent(), TestGetAgentHostEntries_KeyPresentEmptyString(), TestGetAgentHostEntries_KeyPresentValidJSON(), TestGetAgentHostEntries_MalformedJSON() (+1 more)

### Community 96 - "Controller Component"
Cohesion: 0.19
Nodes (22): Migration, VMInfo, VMwareMachine, Scheme, T, NamespacedName, createNewVMwareMachine(), CreateOrUpdateVMwareMachine() (+14 more)
...
Cohesion: 0.39
Nodes (7): BMConfig, init(), BMConfigList, BMConfigSpec, BMConfigStatus, BMCProviderName, BootSource

### Community 101 - "Protobuf Service"
Cohesion: 0.47
Nodes (7): extractTarFile(), getVDDKVersion(), HandleVDDKStatus(), HandleVDDKUpload(), isPathWithinRoot(), VDDKStatusResponse, VDDKUploadResponse

### Community 102 - "Protobuf Service"
Cohesion: 0.25
Nodes (8): RegisterVersionHandler(), RegisterVersionHandlerClient(), RegisterVersionHandlerFromEndpoint(), request_Version_Cleanup_0(), request_Version_GetAvailableTags_0(), request_Version_GetUpgradeProgress_0(), request_Version_InitiateUpgrade_0(), request_Version_Version_0()

### Community 103 - "Protobuf Service"
Cohesion: 0.09
Nodes (27): description, $ref, id, properties, type, properties, description, format (+19 more)

### Community 104 - "Config & Samples"
Cohesion: 0.32
Nodes (3): VjailbreakNodeScope, NewVjailbreakNodeScope(), VjailbreakNodeScopeParams

### Community 105 - "OpenStack Component"
Cohesion: 0.43
Nodes (6): ArrayCredsMapping, init(), ArrayCredsMappingList, ArrayCredsMappingSpec, ArrayCredsMappingStatus, DatastoreArrayCredsMapping

### Community 106 - "Controller Component"
Cohesion: 0.43
Nodes (6): VjailbreakNode, init(), VjailbreakNodeList, VjailbreakNodePhase, VjailbreakNodeSpec, VjailbreakNodeStatus
...
Cohesion: 0.43
Nodes (6): Storage, StorageMapping, init(), StorageMappingList, StorageMappingSpec, StorageMappingStatus

### Community 109 - "Utilities"
Cohesion: 0.43
Nodes (6): PCDHost, init(), PCDHostInterface, PCDHostList, PCDHostSpec, PCDHostStatus

### Community 110 - "Component 110"
Cohesion: 0.43
Nodes (6): VMwareCluster, init(), VMwareClusterList, VMwareClusterPhase, VMwareClusterSpec, VMwareClusterStatus

### Community 111 - "Protobuf Service"
Cohesion: 0.43
Nodes (6): Network, NetworkMapping, init(), NetworkMappingList, NetworkMappingSpec, NetworkMappingStatus

### Community 112 - "Protobuf Service"
Cohesion: 0.43
Nodes (6): ESXIMigration, init(), ESXIMigrationList, ESXIMigrationPhase, ESXIMigrationSpec, ESXIMigrationStatus

### Community 113 - "Protobuf Service"
Cohesion: 0.43
Nodes (6): OpenstackVolumeRef, RDMDisk, init(), RDMDiskList, RDMDiskSpec, RDMDiskStatus

### Community 114 - "Protobuf Service"
Cohesion: 0.43
Nodes (6): VMwareCreds, init(), VMwareCredsInfo, VMwareCredsList, VMwareCredsSpec, VMwareCredsStatus

### Community 115 - "Protobuf Service"
Cohesion: 0.43
Nodes (6): ClusterMigration, init(), ClusterMigrationList, ClusterMigrationPhase, ClusterMigrationSpec, ClusterMigrationStatus

### Community 116 - "OpenStack Component"
Cohesion: 0.43
Nodes (6): ESXiSSHCreds, init(), ESXiSSHCredsInfo, ESXiSSHCredsList, ESXiSSHCredsSpec, ESXiSSHCredsStatus

### Community 117 - "Test Utilities"
Cohesion: 0.17
Nodes (9): ClusterMigrationInfo, RollingMigrationPlanScope, T, VMwareMachine, RollingMigrationPlanScope, NewRollingMigrationPlanScope(), RollingMigrationPlanScopeParams, makePlanScope() (+1 more)
...
Cohesion: 0.48
Nodes (5): VMwareHost, init(), VMwareHostList, VMwareHostSpec, VMwareHostStatus

### Community 125 - "Protobuf Service"
Cohesion: 0.48
Nodes (5): PCDCluster, init(), PCDClusterList, PCDClusterSpec, PCDClusterStatus
...
Cohesion: 0.53
Nodes (4): VolumeImageProfile, init(), VolumeImageProfileList, VolumeImageProfileSpec

### Community 131 - "Controller Component"
Cohesion: 0.53
Nodes (3): ServiceManagerAPI, GetServiceID(), ServicesInfo

### Community 132 - "RBAC Manifests"
Cohesion: 0.53
Nodes (3): EndpointManagerAPI, GetEndpointForRegion(), EndpointsInfo

### Community 134 - "VMware Component"
Cohesion: 0.60
Nodes (3): config, Execute(), parseLogLevel()
...
### Community 140 - "Protobuf Service"
Cohesion: 0.60
Nodes (3): Convert-SubnetToPrefix(), Get-Network(), Write-Log()

### Community 141 - "Protobuf Service"
Cohesion: 0.70
Nodes (3): Atoi(), GetVjailbreakSettings(), VjailbreakSettings
...
Cohesion: 0.12
Nodes (19): parameters, description, location, type, description, location, type, parameters (+11 more)
...
Cohesion: 0.12
Nodes (18): description, enum, enumDescriptions, type, description, items, type, properties (+10 more)

### Community 209 - "Component 209"
Cohesion: 0.11
Nodes (18): Assumptions, Clarifications, Edge Cases, Feature Specification: Inventory Management / Migration Planner, Functional Requirements, Key Entities, Measurable Outcomes, Open clarifications carried into planning (+10 more)
...
Cohesion: 0.18
Nodes (13): parameters, parameters, region, requestId, region, description, location, pattern (+5 more)
...
Cohesion: 0.11
Nodes (17): Dependencies & execution order, Format: `[ID] [P?] [Story] Description`, Notes, Parallelizable now, Phase 10 — Integration: swap UI data layer mock → real API, Phase 11 — Verification & polish, Phase 1 — UI Setup & scaffolding (INFRA), Phase 2 — UI Foundational: types + mockable data layer (INFRA) (+9 more)
...
Cohesion: 0.17
Nodes (12): DetectAndHandleNetwork(), isNetplanSupported(), parseVersionID(), MigrationTimes, NICOverride, PeriodicSyncContext, PeriodicSyncStates, Time (+4 more)
...
Cohesion: 0.25
Nodes (9): parameters, description, id, location, pattern, required, type, operation (+1 more)
...
Cohesion: 0.14
Nodes (18): ListMeta, LocalObjectReference, ObjectMeta, Time, TypeMeta, ListMeta, LocalObjectReference, ObjectMeta (+10 more)
...
Cohesion: 0.17
Nodes (14): Network, OpenStackClients, Port, Network, IsSimpleNetwork(), OpenStackClients, Port, boolPtr() (+6 more)
...
Cohesion: 0.33
Nodes (12): bucket(), newBucketReconciler(), reconcileBucket(), TestMigrationBucket_DefaultsPhase(), TestMigrationBucket_EmptyBucketReportsViolation(), TestMigrationBucket_NotFoundIsNoError(), Client, Scheme (+4 more)
...
Cohesion: 0.20
Nodes (7): MigrationBucketReconciler, Client, Context, Manager, Request, Result, Scheme
...
Cohesion: 0.32
Nodes (3): BMConfigScope, NewBMConfigScope(), BMConfigScopeParams

### Community 257 - "Component 257"
Cohesion: 0.32
Nodes (3): ClusterMigrationScope, NewClusterMigrationScope(), ClusterMigrationScopeParams
...
Cohesion: 0.24
Nodes (5): Reporter, generateRandomString(), IsRunningInPod(), NewReporter(), ReporterOps

### Community 261 - "Controller Component"
Cohesion: 0.29
Nodes (6): Build & deploy (required — run locally; Go toolchain needed), Contracts: MigrationBucket CRD, Controller, Not yet implemented (follow-ups), REST surface (served by kube-apiserver, proxied to the UI), Schema (summary)
...
Cohesion: 0.60
Nodes (3): init(), initProvider(), populateBMCredsFromCMD()
...
Cohesion: 0.27
Nodes (4): buildProviderOptionsFromSpec(), getDatastoreInfo(), validateNetAppTargetSelection(), ArrayCredsReconciler

### Community 294 - "Community 294"
Cohesion: 0.22
Nodes (9): methods, description, httpMethod, id, parameterOrder, path, scopes, delete (+1 more)
...
Cohesion: 0.22
Nodes (9): description, location, type, parameters, oauth_token, quotaUser, description, location (+1 more)
...
Cohesion: 0.33
Nodes (4): convertMappingContextToProto(), convertProtoToMappingContext(), storageArrayGRPC, NewStorageProvider()
...
Cohesion: 0.43
Nodes (3): ArrayCredsScope, NewArrayCredsScope(), ArrayCredsScopeParams

### Community 770 - "Community 770"
Cohesion: 0.25
Nodes (8): description, httpMethod, id, path, get, methods, resources, regionOperations

### Community 771 - "Community 771"
Cohesion: 0.40
Nodes (6): VMwareHost, FilterVMwareHostsForCreds(), FindVMwareHostsNotInVcenter(), HostExistsInVcenter(), VMwareClusterInfo, VMwareHostList

### Community 772 - "Community 772"
Cohesion: 0.29
Nodes (7): description, httpMethod, id, parameterOrder, path, scopes, list

### Community 773 - "Community 773"
Cohesion: 0.29
Nodes (7): default, description, format, location, minimum, type, maxResults

### Community 774 - "Community 774"
Cohesion: 0.33
Nodes (6): project, description, location, pattern, required, type

### Community 775 - "Community 775"
Cohesion: 0.40
Nodes (5): Migration, RollingMigrationPlan, Migration, RollingMigrationPlan, GetVMMigration()

### Community 787 - "Community 787"
Cohesion: 0.40
Nodes (5): description, enum, enumDescriptions, type, addressType

### Community 788 - "Community 788"
Cohesion: 0.40
Nodes (5): type, users, description, items, type
...
Cohesion: 0.40
Nodes (5): purpose, description, enum, enumDescriptions, type

### Community 791 - "Community 791"
Cohesion: 0.50
Nodes (4): description, location, type, key

### Community 792 - "Community 792"
Cohesion: 0.50
Nodes (4): targetId, description, format, type

## Knowledge Gaps
- **1796 isolated node(s):** `@emotion/react`, `@emotion/styled`, `@mui/icons-material`, `@mui/material`, `@mui/x-date-pickers` (+1791 more)
...
- **Why does `Contains()` connect `OpenStack Mock Recorder` to `vpwned Upgrade & Version`, `ESXi Migration Reconciler`, `MigrationPlan API Types`, `Keystone Auth (PCD)`, `Controller Component`, `Migration Credential Utils`, `OpenStack Client`, `PCD Auth & Keystone SDK`, `OpenStack Cinder Operations`, `vpwned vCenter gRPC Target`, `RBAC Roles & CRD Docs`, `Monitoring Stack (Alertmanager)`, `VMwareMachine API Types`, `OpenstackCreds API Types`, `vpwned gRPC Gateway`, `OpenStack Component`, `vpwned Update Response Protobuf`, `vpwned gRPC Server (Storage)`, `Community 293`, `CRD API Types`, `Mock / Test Double`, `CRD API Types`, `Mock / Test Double`, `Utilities`, `CRD API Types`, `CRD API Types`, `OpenStack Component`, `VMware Component`, `Component 80`, `Keystone Auth`, `Protobuf Service`, `Controller Component`, `Controller Component`, `Test Utilities`, `Test Utilities`, `Utilities`, `PCD Integration`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Info` connect `Controller Component` to `ESXi Migration Reconciler`, `Controller Component`, `Component 74`, `Component 42`, `BM Mock Provider`, `VMware Component`, `RBAC Roles & CRD Docs`, `Protobuf Service`, `ESXi SSH Client`, `virt-v2v Mock Operations`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `getHTTPServer()` connect `Component 74` to `Keystone Auth`, `Protobuf Service`, `Protobuf Service`, `VMware Component`, `Component 247`, `Test Utilities`, `Utilities`, `virt-v2v Mock Operations`?**
