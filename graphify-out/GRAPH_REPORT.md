...
## Corpus Check
- 189 files · ~741,848 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2311 nodes · 3817 edges · 190 communities (150 shown, 40 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 829 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b633f727`
...
- [[_COMMUNITY_NBD Protocol|NBD Protocol]]
- [[_COMMUNITY_Protobuf Service|Protobuf Service]]
- [[_COMMUNITY_Protobuf Service|Protobuf Service]]
...
Cohesion: 0.05
Nodes (29): computeSourceVMKey(), createVCenterClientAndDC(), extractVCenterCredentials(), getDatastoresForVolumeMapping(), GetVMwareMachineForVM(), MergeLabels(), resolveVirtioDriverURL(), TestGetDatastoresForVolumeMapping_FallsBackToLegacyDatastores() (+21 more)

### Community 2 - "MigrationPlan API Types"
Cohesion: 0.06
Nodes (40): createDummyPCDCluster(), fetchAndUpdateFlavors(), generateArrayCredsName(), handlePCDSync(), handleValidatedCreds(), populateVMwareMachineFlavors(), runPCDSyncAsync(), syncProjectName() (+32 more)

### Community 3 - "K8s Utilities (Creds, Keys)"
Cohesion: 0.06
Nodes (37): GetManager(), main(), SetupControllers(), setupMasterNode(), VjailbreakNodeReconciler, IsSimpleNetwork(), VjailbreakNodeScope, NewVjailbreakNodeScope() (+29 more)
...
Cohesion: 0.1
Nodes (41): appendToVMErrorsThreadSafe(), appendToVMInfoThreadSafe(), AppendUnique(), CountGPUs(), createNewVMwareMachine(), CreateOrUpdateRDMDisks(), CreateOrUpdateVMwareMachine(), DeleteDependantObjectsForVMwareCreds() (+33 more)
...
Cohesion: 0.1
Nodes (31): DetectESPDiskIndex(), FirstBootWindows, VirtV2VOperations, AddFirstBootScript(), AddNetplanConfig(), CheckForVirtioDrivers(), ConvertDisk(), downloadFile() (+23 more)
...
Cohesion: 0.14
Nodes (25): local_request_BMProvider_DeployMachine_0(), local_request_BMProvider_GetResourceInfo_0(), local_request_BMProvider_ListBootSource_0(), local_request_BMProvider_ListMachines_0(), local_request_BMProvider_ReclaimBMHost_0(), local_request_BMProvider_SetResourceBM2PXEBoot_0(), local_request_BMProvider_SetResourcePower_0(), local_request_BMProvider_WhoAmI_0() (+17 more)
...
Cohesion: 0.14
Nodes (15): DetectAndHandleNetwork(), isNetplanSupported(), parseVersionID(), MigrationTimes, NICOverride, PeriodicSyncContext, AddUdevRules(), AddWildcardNetplan() (+7 more)
...
Cohesion: 0.26
Nodes (16): GetAndCreateAllVMs(), GetFinderForVMwareCreds(), GetVMwareCredentialsFromSecret(), GetVMwDatastore(), LogoutVMwareClient(), ValidateVMwareCreds(), GetMaintenanceModeOptions(), NormalizeVCenterURL() (+8 more)
...
Cohesion: 0.21
Nodes (8): countSuccessfulESXIMigrations(), handleVMMigrations(), ClusterMigrationReconciler, GetClusterMigration(), GetESXIMigration(), IsClusterMigrationPaused(), PauseRollingMigrationPlan(), ResumeRollingMigrationPlan()

### Community 45 - "CRD API Types"
Cohesion: 0.2
Nodes (13): CanEnterMaintenanceMode(), CheckClusterCapacityAfterHostRemoval(), CheckVMForMaintenanceMode(), CreateDefaultValidationConfigMapForRollingMigrationPlan(), GetRollingMigrationPlanValidationConfigFromConfigMap(), getRollingMigrationPlanValidationConfigFromConfigMapName(), GetValidationConfigMapForRollingMigrationPlan(), EnsurePCDHasClusterConfigured() (+5 more)
...
Cohesion: 0.14
Nodes (12): init(), OntapClusterInfo, OntapFlexVol, OntapFlexVolResponse, OntapIgroup, OntapIgroupResponse, OntapLUN, OntapLUNResponse (+4 more)

### Community 58 - "Component 58"
Cohesion: 0.22
Nodes (13): buildBackendToVolumeTypeMap(), extractCinderHost(), GetBackendPools(), getCinderVolumeBackendPools(), getCinderVolumeServiceHosts(), GetOpenStackClients(), GetOpenstackCredentialsFromSecret(), GetOpenstackInfo() (+5 more)
...
Cohesion: 0.7
Nodes (4): TestCreateOrUpdateVMwareMachine_CreatesWhenMissing(), TestFindVMwareMachinesNotInVcenter_SkipsMachineWithMigration(), testScheme(), TestShouldSkipVMwareMachineReconciliation_WhenMigrationExists()
...
## Knowledge Gaps
- **544 isolated node(s):** `Content Quality`, `Requirement Completeness`, `Feature Readiness`, `Notes`, `User Story 1 - Configure Custom Host Entries for Agent Nodes (Priority: P1)` (+539 more)
...
- **Why does `Contains()` connect `ESXi SSH Client` to `vpwned Upgrade & Version`, `ESXi Migration Reconciler`, `MigrationPlan API Types`, `K8s Utilities (Creds, Keys)`, `Keystone Auth (PCD)`, `ArrayCreds Controller`, `Migration Credential Utils`, `Migration Reconciler`, `virt-v2v OS Detection`, `v2v-helper Disk Migration`, `Protobuf Service`, `OpenStack Cinder Operations`, `vpwned vCenter gRPC Target`, `Monitoring Stack (Alertmanager)`, `OpenstackCreds API Types`, `virt-v2v Mock Operations`, `vpwned gRPC Server (Storage)`, `vpwned SDK Targets`, `Component 42`, `CRD API Types`, `Component 58`, `Component 72`, `Component 74`, `VMware Component`, `Component 90`, `Utilities`, `Protobuf Service`, `Protobuf Service`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `Info` connect `CRD API Types` to `ESXi Migration Reconciler`, `K8s Utilities (Creds, Keys)`, `NetApp Storage Provider`, `NBD Disk Copy Protocol`, `vpwned SDK Targets`, `Migration Reconciler`, `CRD API Types`, `Controller Component`, `CRD API Types`, `vpwned Machine Info Protobuf`, `OpenStack Mock Recorder`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `getHTTPServer()` connect `CRD API Types` to `Component 89`, `Controller Component`, `Protobuf Service`, `Protobuf Service`, `Controller Component`, `VMwareMachine API Types`, `OpenStack Mock Recorder`?**
