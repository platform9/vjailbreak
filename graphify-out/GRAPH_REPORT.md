...
## Corpus Check
- 212 files · ~774,810 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2447 nodes · 3978 edges · 202 communities (163 shown, 39 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 844 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `434d67e9`
...
- `TestPasswordRedactionLogic()` --calls--> `Contains()`  [INFERRED]
  v2v-helper/nbd/nbdops_test.go → pkg/utils/credutils.go
...
Cohesion: 0.12
Nodes (6): GetESXiSSHPrivateKey(), Migrate, extractFileName(), MigrationParams, DoRetryWithExponentialBackoff(), GetMigrationParams()

### Community 5 - "ArrayCreds Controller"
Cohesion: 0.09
Nodes (36): DetectAndHandleNetwork(), GetRemoveVMwareTools(), DetectESPDiskIndex(), FirstBootWindows, VirtV2VOperations, AddFirstBootScript(), AddNetplanConfig(), AddUdevRules() (+28 more)
...
Cohesion: 0.14
Nodes (28): appendToVMErrorsThreadSafe(), appendToVMInfoThreadSafe(), AppendUnique(), CountGPUs(), createNewVMwareMachine(), CreateOrUpdateRDMDisks(), CreateOrUpdateVMwareMachine(), DetectGPUUsage() (+20 more)
...
Cohesion: 0.13
Nodes (25): appendScriptToRunCmd(), generatePCDOnboardingCloudInit(), GetBMConfig(), GetBMConfigForRollingMigrationPlan(), GetCloudInitSecretFromRollingMigrationPlan(), GetMigrationPlanFromMigration(), GetMigrationTemplateFromMigration(), GetMigrationTemplateFromMigrationPlan() (+17 more)

### Community 26 - "OpenStack Mock Operations"
Cohesion: 0.16
Nodes (23): ConvertESXiToPCDHost(), GetVMwareCredsFromRollingMigrationPlan(), AddVMsToESXIMigrationStatus(), CheckESXiInMaintenanceMode(), convertBatchToMigrationPlan(), convertVMSequenceToBatches(), ConvertVMSequenceToMigrationPlans(), CountVMsOnESXi() (+15 more)
...
Cohesion: 0.16
Nodes (22): local_request_BMProvider_DeployMachine_0(), local_request_BMProvider_GetResourceInfo_0(), local_request_BMProvider_ListBootSource_0(), local_request_BMProvider_ListMachines_0(), local_request_BMProvider_ReclaimBMHost_0(), local_request_BMProvider_SetResourceBM2PXEBoot_0(), local_request_BMProvider_SetResourcePower_0(), local_request_BMProvider_WhoAmI_0() (+14 more)

### Community 32 - "vpwned Update Response Protobuf"
Cohesion: 0.15
Nodes (16): DeleteNodeByName(), DeleteOpenstackVM(), GetCurrentInstanceNetworkInfo(), GetFlavorIDFromVM(), GetImageIDFromVM(), GetImageIDOfVMBootFromVolume(), GetNodeByName(), GetOpenstackCredsVjailbreakNode() (+8 more)
...
Cohesion: 0.11
Nodes (4): init(), init(), PureStorageProvider, RegisterStorageProvider()
...
Cohesion: 0.13
Nodes (7): RollingMigrationPlanReconciler, RollingMigrationPlanScope, NewRollingMigrationPlanScope(), RollingMigrationPlanScopeParams, GetMigrationPlan(), GetMigrationTemplate(), StringSlicesEqual()
...
Cohesion: 0.12
Nodes (14): convertDatastorePathToFilesystemPath(), NewClient(), NewClientWithTimeout(), parseEsxcliXMLOutput(), EsxcliField, EsxcliListResponse, EsxcliRoot, EsxcliStructure (+6 more)

### Community 42 - "Component 42"
Cohesion: 0.15
Nodes (12): isNetplanSupported(), parseVersionID(), MigrationTimes, NICOverride, PeriodicSyncContext, GetNetworkPersistance(), AddWildcardNetplan(), AddWildcardNetplanForL2() (+4 more)

### Community 43 - "RBAC Manifests"
Cohesion: 0.29
Nodes (15): GetFinderForVMwareCreds(), GetVMwareCredentialsFromSecret(), GetVMwDatastore(), LogoutVMwareClient(), ValidateVMwareCreds(), GetMaintenanceModeOptions(), NormalizeVCenterURL(), CreateDummyClusterForStandAloneESX() (+7 more)
...
Cohesion: 0.26
Nodes (5): ESXIMigrationReconciler, Info, GetOpenstackCredsFromRollingMigrationPlan(), GetVMwareHostFromESXiName(), IsESXIMigrationPaused()
...
Cohesion: 0.14
Nodes (8): init(), init(), IronicProvider, init(), MaasAccessInfo, BMAccessInfo, BMCProvider, RegisterProvider()
...
Cohesion: 0.15
Nodes (13): DeleteDependantObjectsForVMwareCreds(), DeleteStaleVMwareMachines(), DeleteVMwareClustersForVMwareCreds(), DeleteVMwarecredsSecret(), DeleteVMwareHostsForVMwareCreds(), DeleteVMwareMachinesForVMwareCreds(), FilterVMwareClustersForCreds(), FilterVMwareHostsForCreds() (+5 more)
...
Cohesion: 0.24
Nodes (11): CanEnterMaintenanceMode(), CheckClusterCapacityAfterHostRemoval(), CheckVMForMaintenanceMode(), CreateDefaultValidationConfigMapForRollingMigrationPlan(), GetRollingMigrationPlanValidationConfigFromConfigMap(), getRollingMigrationPlanValidationConfigFromConfigMapName(), GetValidationConfigMapForRollingMigrationPlan(), isBMConfigValid() (+3 more)
...
Cohesion: 0.17
Nodes (12): initiatorMatches(), isWWPNLike(), OntapClusterInfo, OntapFlexVol, OntapFlexVolResponse, OntapIgroup, OntapIgroupResponse, OntapLUN (+4 more)

### Community 69 - "CRD API Types"
Cohesion: 0.27
Nodes (5): countSuccessfulESXIMigrations(), handleVMMigrations(), ClusterMigrationReconciler, GetESXIMigration(), IsClusterMigrationPaused()
...
Cohesion: 0.29
Nodes (9): collectVMsFromDatacenters(), GetAndCreateAllVMs(), PostValidationResources, ensureLogger(), FetchResourcesPostValidation(), getCredentialsFromSecret(), getRetryLimitFromSettings(), Validate() (+1 more)

### Community 84 - "Protobuf Service"
Cohesion: 0.29
Nodes (5): TestCreateOrUpdateVMwareMachine_CreatesWhenMissing(), TestFindVMwareMachinesNotInVcenter_SkipsMachineWithMigration(), testScheme(), TestShouldSkipVMwareMachineReconciliation_WhenMigrationExists(), TestShouldSkipVMwareMachineReconciliation_WhenMigrationExistsWithAnnotation()

### Community 85 - "Protobuf Service"
Cohesion: 0.24
Nodes (8): GetManager(), main(), SetupControllers(), CheckAndCreateMasterNodeEntry(), GetAllk8sNodes(), GetMasterK8sNode(), GetNodeInternalIP(), IsMasterNode()
...
Cohesion: 0.33
Nodes (7): atoi(), GetInclusterClient(), GetRDMDisk(), GetSourceVMKey(), GetVjailbreakSettingsOriginal(), GetVMwareMachine(), GetVMwareMachineName()
...
Cohesion: 0.29
Nodes (7): IsSimpleNetwork(), boolPtr(), CreateOpenstackVMForWorkerNode(), createPortForL2Network(), GetImageID(), GetInstanceNetworkInfoByID(), GetVolumeTypeAndAvailabilityZoneFromVM()
...
Cohesion: 0.29
Nodes (7): local_request_VCenter_CordonHost_0(), local_request_VCenter_GetVM_0(), local_request_VCenter_ListHosts_0(), local_request_VCenter_ListVMs_0(), local_request_VCenter_ReclaimVM_0(), local_request_VCenter_UnCordonHost_0(), RegisterVCenterHandlerServer()

### Community 124 - "VMware Component"
Cohesion: 0.33
Nodes (5): Content Quality, Feature Readiness, Notes, Requirement Completeness, Specification Quality Checklist: Agent Node Custom Host Entries
...
## Knowledge Gaps
- **605 isolated node(s):** `Quick References`, `External Documentation`, `Clarifying Questions (NON-NEGOTIABLE)`, `Skills Invocation (NON-NEGOTIABLE)`, `Security Features` (+600 more)
...
- **Why does `Contains()` connect `OpenStack Mock Recorder` to `Protobuf Service`, `ESXi Migration Reconciler`, `MigrationPlan API Types`, `K8s Utilities (Creds, Keys)`, `Keystone Auth (PCD)`, `ArrayCreds Controller`, `Migration Credential Utils`, `vpwned Upgrade & Version`, `v2v-helper Disk Migration`, `OpenStack Cinder Operations`, `vpwned Protobuf API`, `BMConfig CLI & Controller`, `Protobuf Service`, `ESXi SSH Client`, `vpwned gRPC Gateway`, `Protobuf Service`, `vpwned Update Response Protobuf`, `vpwned gRPC Server (Storage)`, `NetApp Storage Provider`, `vpwned SDK Targets`, `Component 42`, `RBAC Manifests`, `Protobuf Service`, `OpenStack Component`, `Component 78`, `VMware Component`, `VMware Component`, `Protobuf Service`, `Protobuf Service`, `Keystone Auth`, `Controller Component`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `Info` connect `CRD API Types` to `vpwned Update Response Protobuf`, `ESXi Migration Reconciler`, `CRD API Types`, `CRD API Types`, `NBD Disk Copy Protocol`, `Component 40`, `Controller Component`, `RBAC Manifests`, `Rolling Migration Utils`, `Protobuf Service`, `BMConfig CLI & Controller`, `OpenStack Mock Operations`, `CRD API Types`, `virt-v2v Mock Operations`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `getHTTPServer()` connect `RBAC Manifests` to `Test Utilities`, `Test Utilities`, `Config & Samples`, `OpenStack Component`, `Component 81`, `Component 122`, `virt-v2v Mock Operations`?**
