...
## Corpus Check
- 187 files · ~740,260 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2056 nodes · 3316 edges · 178 communities (140 shown, 38 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 577 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `badf8aa6`
...
1. `PrintLog()` - 69 edges
2. `Migrate` - 54 edges
3. `MigrationPlanReconciler` - 41 edges
4. `Client` - 38 edges
5. `OpenStackClients` - 33 edges
6. `GetK8sCompatibleVMWareObjectName()` - 31 edges
7. `NetAppStorageProvider` - 30 edges
8. `VMOps` - 22 edges
9. `UpgradeExecutor` - 22 edges
10. `RBAC Kustomization` - 21 edges
...
Cohesion: 0.05
Nodes (30): computeSourceVMKey(), createVCenterClientAndDC(), extractVCenterCredentials(), getDatastoresForVolumeMapping(), GetVMwareMachineForVM(), MergeLabels(), resolveVirtioDriverURL(), TestGetDatastoresForVolumeMapping_FallsBackToLegacyDatastores() (+22 more)

### Community 2 - "MigrationPlan API Types"
Cohesion: 0.06
Nodes (36): GetManager(), main(), SetupControllers(), VjailbreakNodeReconciler, IsSimpleNetwork(), VjailbreakNodeScope, NewVjailbreakNodeScope(), VjailbreakNodeScopeParams (+28 more)

### Community 3 - "K8s Utilities (Creds, Keys)"
Cohesion: 0.07
Nodes (27): atoi(), GetESXiSSHPrivateKey(), GetInclusterClient(), GetRDMDisk(), GetSourceVMKey(), GetVjailbreakSettingsOriginal(), GetVMwareMachine(), GetVMwareMachineName() (+19 more)

### Community 4 - "Keystone Auth (PCD)"
Cohesion: 0.06
Nodes (33): createDummyPCDCluster(), fetchAndUpdateFlavors(), generateArrayCredsName(), handlePCDSync(), handleValidatedCreds(), populateVMwareMachineFlavors(), runPCDSyncAsync(), setupMasterNode() (+25 more)

### Community 5 - "ArrayCreds Controller"
Cohesion: 0.04
Nodes (35): AuthInfo, AuthRequest, AuthRequestAuth, AuthRequestAuthIdentity, AuthRequestAuthIdentityPassword, AuthRequestAuthIdentityPasswordUser, AuthRequestAuthScope, AuthRequestAuthScopeProject (+27 more)
...
Cohesion: 0.11
Nodes (5): NewCloneTracker(), GetArrayCreds(), Migrate, extractFileName(), sanitizeVolumeName()

### Community 8 - "virt-v2v OS Detection"
Cohesion: 0.08
Nodes (35): DetectAndHandleNetwork(), GetRemoveVMwareTools(), DetectESPDiskIndex(), FirstBootWindows, VirtV2VOperations, AddNetplanConfig(), AddUdevRules(), AddWildcardNetplan() (+27 more)

### Community 9 - "OpenStack Client"
Cohesion: 0.05
Nodes (10): init(), UnimplementedBaseProvider, init(), IronicProvider, init(), MaasAccessInfo, MaasProvider, BMAccessInfo (+2 more)
...
Cohesion: 0.08
Nodes (30): NewClient(), OpenstackOperations, authOptionsFromEnv(), NewOpenStackClients(), validateOpenStack(), checkNetworkSubnetCompatibilityRequest, checkNetworkSubnetCompatibilityResponse, OpenStackClients (+22 more)
...
Cohesion: 0.12
Nodes (32): appendToVMErrorsThreadSafe(), appendToVMInfoThreadSafe(), AppendUnique(), Contains(), CountGPUs(), createNewVMwareMachine(), CreateOrUpdateRDMDisks(), CreateOrUpdateVMwareMachine() (+24 more)

### Community 18 - "vpwned Machine Info Protobuf"
Cohesion: 0.09
Nodes (14): assignHypervisor, bundle, Cluster, Config, Extensions, ExtensionsData, Host, Impl (+6 more)
...
Cohesion: 0.08
Nodes (3): NewMaasClient(), MaasClient, VjbNet

### Community 23 - "Monitoring Stack (Alertmanager)"
Cohesion: 0.13
Nodes (27): local_request_VCenter_CordonHost_0(), local_request_VCenter_GetVM_0(), local_request_VCenter_ListHosts_0(), local_request_VCenter_ListVMs_0(), local_request_VCenter_ReclaimVM_0(), local_request_VCenter_UnCordonHost_0(), RegisterBMProviderHandler(), RegisterBMProviderHandlerClient() (+19 more)
...
Cohesion: 0.14
Nodes (22): appendScriptToRunCmd(), generatePCDOnboardingCloudInit(), GetBMConfig(), GetBMConfigForRollingMigrationPlan(), GetCloudInitSecretFromRollingMigrationPlan(), GetMigrationPlanFromMigration(), GetMigrationTemplateFromMigration(), GetMigrationTemplateFromMigrationPlan() (+14 more)

### Community 26 - "OpenStack Mock Operations"
Cohesion: 0.12
Nodes (15): TestPeriodicSyncStatesString(), PeriodicSyncStates, MigrationParams, DoRetryWithExponentialBackoff(), GetFirstbootConfigMapName(), GetInclusterClient(), GetMigrationConfigMapName(), GetMigrationObjectName() (+7 more)
...
Cohesion: 0.12
Nodes (10): AccessInfo, Targets, RegisterTarget(), VMInfo, Vcenter, findBootDevice(), findPowerStatus(), init() (+2 more)

### Community 30 - "virt-v2v Mock Operations"
Cohesion: 0.16
Nodes (17): GetVMwareCredsFromRollingMigrationPlan(), GetVMwareCredsInfoFromRollingMigrationPlan(), GetVMwareCredsInfo(), AddVMsToESXIMigrationStatus(), convertBatchToMigrationPlan(), convertVMSequenceToBatches(), ConvertVMSequenceToMigrationPlans(), CreateClusterMigration() (+9 more)
...
Cohesion: 0.13
Nodes (8): RollingMigrationPlanReconciler, RollingMigrationPlanScope, NewRollingMigrationPlanScope(), RollingMigrationPlanScopeParams, GetValidationConfigMapForRollingMigrationPlan(), IsRollingMigrationPlanPaused(), StringSlicesEqual(), UpdateESXiNamesInRollingMigrationPlan()
...
Cohesion: 0.12
Nodes (13): NewClient(), NewClientWithTimeout(), parseEsxcliXMLOutput(), EsxcliField, EsxcliListResponse, EsxcliRoot, EsxcliStructure, EsxcliStructureList (+5 more)
...
Cohesion: 0.17
Nodes (10): isNetplanSupported(), parseVersionID(), MigrationTimes, NICOverride, PeriodicSyncContext, GetNetworkPersistance(), AddWildcardNetplanForL2(), InjectMacToIps() (+2 more)
...
Cohesion: 0.2
Nodes (7): ESXIMigrationReconciler, ConvertESXiToPCDHost(), CheckESXiInMaintenanceMode(), CountVMsOnESXi(), IsESXIMigrationPaused(), PutESXiInMaintenanceMode(), RemoveESXiFromVCenter()

### Community 50 - "CRD API Types"
Cohesion: 0.15
Nodes (13): init(), initiatorMatches(), isWWPNLike(), OntapClusterInfo, OntapFlexVol, OntapFlexVolResponse, OntapIgroup, OntapIgroupResponse (+5 more)
...
Cohesion: 0.23
Nodes (11): DeleteStaleVMwareMachines(), DeleteVMwareMachinesForVMwareCreds(), FilterVMwareMachinesForCreds(), FindVMwareMachinesNotInVcenter(), migrationMatchesVMwareMachine(), ShouldSkipVMwareMachineReconciliation(), TestCreateOrUpdateVMwareMachine_CreatesWhenMissing(), TestFindVMwareMachinesNotInVcenter_SkipsMachineWithMigration() (+3 more)
...
Cohesion: 0.24
Nodes (7): serve(), APILogger(), getHTTPServer(), openAPIServer(), Shutdown(), startgRPCServer(), StartServer()
...
Cohesion: 0.29
Nodes (9): CanEnterMaintenanceMode(), CheckClusterCapacityAfterHostRemoval(), CheckVMForMaintenanceMode(), CreateDefaultValidationConfigMapForRollingMigrationPlan(), GetRollingMigrationPlanValidationConfigFromConfigMap(), getRollingMigrationPlanValidationConfigFromConfigMapName(), isBMConfigValid(), ValidateRollingMigrationPlan() (+1 more)

### Community 63 - "CRD API Types"
Cohesion: 0.27
Nodes (5): NewTestClient(), TestGetEndpointForRegion(), TestGetServiceID(), RoundTripFunc, Ok()
...
Cohesion: 0.22
Nodes (9): local_request_BMProvider_DeployMachine_0(), local_request_BMProvider_GetResourceInfo_0(), local_request_BMProvider_ListBootSource_0(), local_request_BMProvider_ListMachines_0(), local_request_BMProvider_ReclaimBMHost_0(), local_request_BMProvider_SetResourceBM2PXEBoot_0(), local_request_BMProvider_SetResourcePower_0(), local_request_BMProvider_WhoAmI_0() (+1 more)
...
Cohesion: 0.47
Nodes (5): GetThumbprint(), cleanupSimulator(), simulateVCenter(), TestGetThumbprint(), TestGetVMByName()
...
Cohesion: 0.67
Nodes (3): VCenterOperations, validateVCenter(), VCenterClientBuilder()
...
## Knowledge Gaps
- **334 isolated node(s):** `Quick References`, `External Documentation`, `CRD Changes`, `Generated Files`, `Git Workflow` (+329 more)
...
- **Why does `NewVjbNet()` connect `Config Samples & Templates` to `vpwned gRPC Server (Storage)`, `Keystone Auth (PCD)`, `NetApp Storage Provider`, `Migration Reconciler`, `vpwned SDK Targets`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `PrintLog()` connect `BM Mock Provider` to `Migration Reconciler`, `virt-v2v OS Detection`, `RBAC Manifests`, `Mock / Test Double`, `OpenStack Mock Operations`, `OpenStack Mock Recorder`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `NewStorageProvider()` connect `Migration Credential Utils` to `Migration Reconciler`?**
...
- **Should `ESXi Migration Reconciler` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._