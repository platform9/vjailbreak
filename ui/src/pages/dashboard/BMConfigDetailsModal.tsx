...
export default function MaasConfigDetailsModal({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle>Bare Metal Configuration Details</DialogTitle>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={8}>
                  <DetailItem>
                    ...
                    <Typography variant="body1">{config.spec.apiUrl || 'Not specified'}</Typography>
                  </DetailItem>
                </Grid>
                <Grid item xs={12} md={4}>
                  <DetailItem>
                    ...
                    <Switch checked={config.spec.insecure} disabled color="primary" />
                  </DetailItem>
                </Grid>
                <Grid item xs={12}>
                  <Box sx={{ display: 'flex', gap: 4 }}>
                    <Box sx={{ flex: 1 }}>
                      ...
                      >
                        OS
                        <Tooltip
                          title="Currently only Ubuntu Jammy (22.04) is supported for ESXi host deployments."
                          arrow
                        >
                          <InfoIcon fontSize="small" sx={{ ml: 1, opacity: 0.7 }} />
                        </Tooltip>
                      </Typography>
                      <Typography variant="body1">{config.spec.os || 'Not specified'}</Typography>
                    </Box>
                    <Box sx={{ flex: 1 }}>
                      <Typography variant="subtitle2" color="text.secondary">
                        Provider Type
