import { DataGrid, GridColDef, GridToolbarContainer, GridRowParams } from '@mui/x-data-grid'
...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    renderCell: (params) => (
      <Tooltip
        title={
          params.row.role === 'master'
            ? 'Master node cannot be scaled down'
            : params.row.activeMigrations.length > 0
              ? 'Node has active migrations'
              : 'Scale down node'
        }
      >
        <span>
