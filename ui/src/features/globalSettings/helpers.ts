export type SettingsForm = {
  ...
  PERIODIC_SYNC_COOLING_ENABLED: boolean
  PERIODIC_SYNC_COOLING_MULTIPLIER: number
...
export const getGlobalSettingsHelpers = (defaults: SettingsForm) => {
  ...
  const toConfigMapData = (f: SettingsForm): Record<string, string> => ({
    ...
    PERIODIC_SYNC_COOLING_ENABLED: String(f.PERIODIC_SYNC_COOLING_ENABLED),
    PERIODIC_SYNC_COOLING_MULTIPLIER: String(f.PERIODIC_SYNC_COOLING_MULTIPLIER),
  ...
  const fromConfigMapData = (
    ...
    PERIODIC_SYNC_COOLING_ENABLED: parseBool(
      data?.PERIODIC_SYNC_COOLING_ENABLED,
      defaults.PERIODIC_SYNC_COOLING_ENABLED
    ),
    PERIODIC_SYNC_COOLING_MULTIPLIER: parseNum(
      data?.PERIODIC_SYNC_COOLING_MULTIPLIER,
      defaults.PERIODIC_SYNC_COOLING_MULTIPLIER
    ),
