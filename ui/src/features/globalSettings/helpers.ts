export type SettingsForm = {
  ...
  // v2v-helper pod resource tuning
  V2V_HELPER_POD_CPU_REQUEST: string
  V2V_HELPER_POD_MEMORY_REQUEST: string
  V2V_HELPER_POD_CPU_LIMIT: string
  V2V_HELPER_POD_MEMORY_LIMIT: string
  V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST: string
  V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT: string
...
export const getGlobalSettingsHelpers = (defaults: SettingsForm) => {
  ...
  const toConfigMapData = (f: SettingsForm): Record<string, string> => ({
    ...
    V2V_HELPER_POD_CPU_REQUEST: f.V2V_HELPER_POD_CPU_REQUEST,
    V2V_HELPER_POD_MEMORY_REQUEST: f.V2V_HELPER_POD_MEMORY_REQUEST,
    V2V_HELPER_POD_CPU_LIMIT: f.V2V_HELPER_POD_CPU_LIMIT,
    V2V_HELPER_POD_MEMORY_LIMIT: f.V2V_HELPER_POD_MEMORY_LIMIT,
    V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST: f.V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST,
    V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT: f.V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT
  })
  ...
  const fromConfigMapData = (
    ...
    V2V_HELPER_POD_CPU_REQUEST:
      typeof data?.V2V_HELPER_POD_CPU_REQUEST === 'string'
        ? data.V2V_HELPER_POD_CPU_REQUEST
        : defaults.V2V_HELPER_POD_CPU_REQUEST,
    ...
    V2V_HELPER_POD_CPU_LIMIT:
      typeof data?.V2V_HELPER_POD_CPU_LIMIT === 'string'
        ? data.V2V_HELPER_POD_CPU_LIMIT
        : defaults.V2V_HELPER_POD_CPU_LIMIT,
    ...
    V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST:
      typeof data?.V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST === 'string'
        ? data.V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST
        : defaults.V2V_HELPER_POD_EPHEMERAL_STORAGE_REQUEST,
    V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT:
      typeof data?.V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT === 'string'
        ? data.V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT
        : defaults.V2V_HELPER_POD_EPHEMERAL_STORAGE_LIMIT,
