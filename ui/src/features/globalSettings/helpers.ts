export type SettingsForm = {
  ...
  // v2v-helper pod resource settings
...
export const getGlobalSettingsHelpers = (defaults: SettingsForm) => {
  ...
  const toConfigMapData = (f: SettingsForm): Record<string, string> => ({
    ...
    VIRTV2V_MEMSIZE_MB: String(f.VIRTV2V_MEMSIZE_MB)
  })
  ...
  const fromConfigMapData = (
    ...
    V2V_HELPER_POD_CPU_REQUEST:
      typeof data?.V2V_HELPER_POD_CPU_REQUEST === 'string' && data.V2V_HELPER_POD_CPU_REQUEST
        ? data.V2V_HELPER_POD_CPU_REQUEST
        : defaults.V2V_HELPER_POD_CPU_REQUEST,
    V2V_HELPER_POD_CPU_LIMIT:
      typeof data?.V2V_HELPER_POD_CPU_LIMIT === 'string' && data.V2V_HELPER_POD_CPU_LIMIT
        ? data.V2V_HELPER_POD_CPU_LIMIT
        : defaults.V2V_HELPER_POD_CPU_LIMIT,
    V2V_HELPER_POD_MEMORY_REQUEST:
      typeof data?.V2V_HELPER_POD_MEMORY_REQUEST === 'string' && data.V2V_HELPER_POD_MEMORY_REQUEST
        ? data.V2V_HELPER_POD_MEMORY_REQUEST
        : defaults.V2V_HELPER_POD_MEMORY_REQUEST,
    V2V_HELPER_POD_MEMORY_LIMIT:
      typeof data?.V2V_HELPER_POD_MEMORY_LIMIT === 'string' && data.V2V_HELPER_POD_MEMORY_LIMIT
        ? data.V2V_HELPER_POD_MEMORY_LIMIT
        : defaults.V2V_HELPER_POD_MEMORY_LIMIT,
    VIRTV2V_MEMSIZE_MB: parseNum(data?.VIRTV2V_MEMSIZE_MB, defaults.VIRTV2V_MEMSIZE_MB),
