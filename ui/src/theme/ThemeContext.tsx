...
import {
    ...
    WHITE, BLACK,
    // Background colors
    DARK_BG_PRIMARY, DARK_BG_PAPER,
    LIGHT_BG_DEFAULT,
    // Text colors
    LIGHT_TEXT_PRIMARY, LIGHT_TEXT_SECONDARY,
    DARK_TEXT_PRIMARY, DARK_TEXT_SECONDARY,
    // UI Element colors - Dark mode
    DARK_DIVIDER, DARK_BORDER_LIGHT, DARK_BORDER_MEDIUM,
    DARK_HOVER_BG, DARK_HOVER_BG_STRONGER,
    DARK_BUTTON_BG, DARK_BUTTON_BG_HOVER,
    // UI Element colors - Light mode
    LIGHT_DIVIDER,
    // Scrollbar colors
    DARK_SCROLLBAR_BG, DARK_SCROLLBAR_THUMB,
    LIGHT_SCROLLBAR_BG, LIGHT_SCROLLBAR_THUMB,
    // Status colors
    DARK_ERROR, DARK_WARNING, DARK_INFO, DARK_SUCCESS,
    LIGHT_ERROR, LIGHT_WARNING, LIGHT_INFO, LIGHT_SUCCESS,
    // Secondary palette colors
    DARK_SECONDARY, DARK_SECONDARY_DARK, DARK_SECONDARY_LIGHT,
    LIGHT_SECONDARY, LIGHT_SECONDARY_DARK, LIGHT_SECONDARY_LIGHT
} from './colors';
