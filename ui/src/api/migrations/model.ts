...
export enum Phase {
  ...
  SnapshottingSourceVM = 'SnapshottingSourceVM',
  AttachingDisksToProxy = 'AttachingDisksToProxy',
  IdentifyingBlockDevices = 'IdentifyingBlockDevices',
  HotAddTransferInProgress = 'HotAddTransferInProgress',
  HotAddCleanup = 'HotAddCleanup',
