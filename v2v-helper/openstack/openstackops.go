...
type OpenstackOperations interface {
	...
	CreatePort(networkid *networks.Network, mac string, ip []string, ipPerMac map[string][]string, vmname string, securityGroups []string, fallbackToDHCP bool, gatewayIP map[string]string) (*ports.Port, error)
