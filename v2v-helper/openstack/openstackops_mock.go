...
//
//	mockgen -source=openstack/openstackops.go -destination=openstack/openstackops_mock.go --package=openstack
//
...
func (mr *MockOpenstackOperationsMockRecorder) AttachVolumeToVM(volumeID any) *gomock.Call {
...
func (mr *MockOpenstackOperationsMockRecorder) CreatePort(networkid, mac, ip, vmname any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) CreateVM(flavor, networkIDs, portIDs, vminfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) CreateVolume(name, size, ostype, uefi, volumetype any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) DeleteVolume(volumeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) DetachVolumeFromVM(volumeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) EnableQGA(volume any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) FindDevice(volumeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) GetClosestFlavour(cpu, memory any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) GetNetwork(networkname any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) GetPort(portID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) SetVolumeBootable(volume any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) SetVolumeImageMetadata(volume any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) SetVolumeUEFI(volume any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) WaitForVolume(volumeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenstackOperationsMockRecorder) WaitForVolumeAttachment(volumeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
