...
//
//	mockgen -source=nbd/nbdops.go -destination=nbd/nbdops_mock.go --package=nbd
//
...
func (mr *MockNBDOperationsMockRecorder) CopyChangedBlocks(ctx, changedAreas, path any) *gomock.Call {
...
func (mr *MockNBDOperationsMockRecorder) CopyDisk(ctx, dest any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNBDOperationsMockRecorder) StartNBDServer(vm, server, username, password, thumbprint, snapref, file, progchan any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
