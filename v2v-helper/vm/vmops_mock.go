...
//
//	mockgen -source=vm/vmops.go -destination=vm/vmops_mock.go --package=vm
//
...
func (mr *MockVMOperationsMockRecorder) CustomQueryChangedDiskAreas(baseChangeID, curSnapshot, disk, offset any) *gomock.Call {
...
func (mr *MockVMOperationsMockRecorder) DeleteSnapshot(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVMOperationsMockRecorder) GetSnapshot(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVMOperationsMockRecorder) GetVMInfo(ostype any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVMOperationsMockRecorder) TakeSnapshot(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVMOperationsMockRecorder) UpdateDiskInfo(vminfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
