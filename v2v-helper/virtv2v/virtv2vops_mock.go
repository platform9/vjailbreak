...
//
//	mockgen -source=virtv2v/virtv2vops.go -destination=virtv2v/virtv2vops_mock.go --package=virtv2v
//
...
func (mr *MockVirtV2VOperationsMockRecorder) AddFirstBootScript(firstbootscript, firstbootscriptname any) *gomock.Call {
...
func (mr *MockVirtV2VOperationsMockRecorder) AddWildcardNetplan(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtV2VOperationsMockRecorder) ConvertDisk(ctx, path, ostype, virtiowindriver, firstbootscripts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtV2VOperationsMockRecorder) GetOsRelease(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtV2VOperationsMockRecorder) GetPartitions(disk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtV2VOperationsMockRecorder) NTFSFix(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtV2VOperationsMockRecorder) RetainAlphanumeric(input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
