...
require (
	...
	github.com/platform9/vjailbreak/v2v-helper/esxi-ssh v0.0.0-00010101000000-000000000000 // indirect
...
replace github.com/platform9/vjailbreak/v2v-helper/esxi-ssh => ./esxi-ssh
