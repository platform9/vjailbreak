...
import (
	...
	gophercl "github.com/gophercloud/gophercloud"
...
func ExecuteVolumeManageRequest(ctx context.Context, rdmDisk v1alpha1.RDMDisk, osclient *utils.OpenStackClients, openstackAPIVersion string) (*volumes.Volume, error) {
	...
	response, err := osclient.BlockStorageClient.Post(osclient.BlockStorageClient.ServiceURL("manageable_volumes"), body, &result, &gophercl.RequestOpts{
