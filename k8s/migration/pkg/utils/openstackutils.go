...
func ImportLUNToCinder(ctx context.Context, openstackClient *utils.OpenStackClients, rdmDisk vm.RDMDisk, volumeAPIVersion string) (string, error) {
...
func ExecuteVolumeManageRequest(ctx context.Context, rdmDisk vm.RDMDisk, osclient *utils.OpenStackClients, openstackAPIVersion string) (*volumes.Volume, error) {
