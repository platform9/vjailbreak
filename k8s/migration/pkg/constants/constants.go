...
const (
	...
	// OpenstackCredsRequeueAfter is the requeue after duration for openstack credentials
	OpenstackCredsRequeueAfter = 1 * time.Minute

	// VMwareCredsRequeueAfter is the requeue after duration for vmware credentials
