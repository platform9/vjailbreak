...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LUNInfo) DeepCopyInto(out *LUNInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LUNInfo.
func (in *LUNInfo) DeepCopy() *LUNInfo {
	if in == nil {
		return nil
	}
	out := new(LUNInfo)
