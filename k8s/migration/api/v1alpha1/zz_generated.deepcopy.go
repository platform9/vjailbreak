...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretReferenece) DeepCopyInto(out *SecretReferenece) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretReferenece.
func (in *SecretReferenece) DeepCopy() *SecretReferenece {
	if in == nil {
		return nil
	}
	out := new(SecretReferenece)
	in.DeepCopyInto(out)
	return out
}
