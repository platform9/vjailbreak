...
var _ = Describe("VjailbreakNode Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind VjailbreakNode")
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance VjailbreakNode")
