...
var _ = Describe("VMwareCreds Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind VMwareCreds")
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance VMwareCreds")
