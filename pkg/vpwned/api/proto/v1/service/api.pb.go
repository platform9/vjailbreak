...
func (x *UploadVDDKRequest) Reset() {
	*x = UploadVDDKRequest{}
...
func (x *UploadVDDKRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadVDDKRequest) ProtoMessage() {}

func (x *UploadVDDKRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_proto_v1_api_proto_msgTypes[58]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UploadVDDKRequest.ProtoReflect.Descriptor instead.
func (*UploadVDDKRequest) Descriptor() ([]byte, []int) {
	return file_sdk_proto_v1_api_proto_rawDescGZIP(), []int{58}
}

func (x *UploadVDDKRequest) GetFileChunk() []byte {
	if x != nil {
		return x.FileChunk
	}
	return nil
...
func (x *UploadVDDKRequest) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *UploadVDDKRequest) GetChunkIndex() int64 {
	if x != nil {
		return x.ChunkIndex
	}
	return 0
...
func (x *UploadVDDKRequest) GetTotalChunks() int64 {
	if x != nil {
...
func (x *UploadVDDKRequest) GetUploadId() string {
	if x != nil {
		return x.UploadId
	}
	return ""
...
type UploadVDDKResponse struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	UploadId           string                 `protobuf:"bytes,1,opt,name=upload_id,json=uploadId,proto3" json:"upload_id,omitempty"`
	Status             string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	Message            string                 `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
	ExtractDir         string                 `protobuf:"bytes,4,opt,name=extract_dir,json=extractDir,proto3" json:"extract_dir,omitempty"`
...
func (x *UploadVDDKResponse) Reset() {
	*x = UploadVDDKResponse{}
	mi := &file_sdk_proto_v1_api_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UploadVDDKResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadVDDKResponse) ProtoMessage() {}

func (x *UploadVDDKResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sdk_proto_v1_api_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UploadVDDKResponse.ProtoReflect.Descriptor instead.
func (*UploadVDDKResponse) Descriptor() ([]byte, []int) {
	return file_sdk_proto_v1_api_proto_rawDescGZIP(), []int{59}
}

func (x *UploadVDDKResponse) GetUploadId() string {
	if x != nil {
		return x.UploadId
	}
	return ""
...
func (x *UploadVDDKResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *UploadVDDKResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *UploadVDDKResponse) GetExtractDir() string {
	if x != nil {
		return x.ExtractDir
	}
	return ""
...
func (x *UploadVDDKResponse) GetBytesReceived() int64 {
	if x != nil {
...
func (x *UploadVDDKResponse) GetProgressPercentage() float32 {
	if x != nil {
...
const file_sdk_proto_v1_api_proto_rawDesc = "" +
	...
	"\x11UploadVDDKRequest\x12\x1d\n" +
	"\n" +
	"file_chunk\x18\x01 \x01(\fR\tfileChunk\x12\x1a\n" +
	"\bfilename\x18\x02 \x01(\tR\bfilename\x12\x1f\n" +
	"\vchunk_index\x18\x03 \x01(\x03R\n" +
	"chunkIndex\x12!\n" +
	"\ftotal_chunks\x18\x04 \x01(\x03R\vtotalChunks\x12\x1b\n" +
	"\tupload_id\x18\x05 \x01(\tR\buploadId\"\xdc\x01\n" +
	"\x12UploadVDDKResponse\x12\x1b\n" +
	"\tupload_id\x18\x01 \x01(\tR\buploadId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12\x1f\n" +
	"\vextract_dir\x18\x04 \x01(\tR\n" +
	"extractDir\x12%\n" +
	"\x0ebytes_received\x18\x05 \x01(\x03R\rbytesReceived\x12/\n" +
	"\x13progress_percentage\x18\x06 \x01(\x02R\x12progressPercentage\"(\n" +
	...
	"\rDeployMachine\x12\x19.api.DeployMachineRequest\x1a\x1a.api.DeployMachineResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/vpw/v1/deploy_machine2\x82\x03\n" +
	...
	"\x15RevalidateCredentials\x12!.api.RevalidateCredentialsRequest\x1a\".api.RevalidateCredentialsResponse\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/vpw/v1/revalidate_credentials\x12_\n" +
	"\n" +
	"UploadVDDK\x12\x16.api.UploadVDDKRequest\x1a\x17.api.UploadVDDKResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/vpw/v1/upload_vddk(\x01B$\n" +
...
var file_sdk_proto_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_sdk_proto_v1_api_proto_goTypes = []any{
	...
	(*UploadVDDKRequest)(nil),             // 60: api.UploadVDDKRequest
	(*UploadVDDKResponse)(nil),            // 61: api.UploadVDDKResponse
...
var file_sdk_proto_v1_api_proto_depIdxs = []int32{
	...
	62, // 44: api.Version.CleanupStep:input_type -> api.CleanupStepRequest
	...
	58, // 60: api.VailbreakProxy.RevalidateCredentials:input_type -> api.RevalidateCredentialsRequest
	60, // 61: api.VailbreakProxy.UploadVDDK:input_type -> api.UploadVDDKRequest
	4,  // 62: api.Version.Version:output_type -> api.VersionResponse
	9,  // 63: api.Version.InitiateUpgrade:output_type -> api.UpgradeResponse
	10, // 64: api.Version.GetUpgradeProgress:output_type -> api.UpgradeProgressResponse
	6,  // 65: api.Version.GetAvailableTags:output_type -> api.AvailableUpdatesResponse
	9,  // 66: api.Version.ConfirmCleanupAndUpgrade:output_type -> api.UpgradeResponse
	63, // 67: api.Version.CleanupStep:output_type -> api.CleanupStepResponse
	20, // 68: api.VCenter.ListVMs:output_type -> api.ListVMsResponse
	22, // 69: api.VCenter.GetVM:output_type -> api.GetVMResponse
	24, // 70: api.VCenter.ReclaimVM:output_type -> api.ReclaimVMResponse
	26, // 71: api.VCenter.CordonHost:output_type -> api.CordonHostResponse
	18, // 72: api.VCenter.UnCordonHost:output_type -> api.UnCordonHostResponse
	15, // 73: api.VCenter.ListHosts:output_type -> api.ListHostsResponse
	30, // 74: api.BMProvider.ListMachines:output_type -> api.BMListMachinesResponse
	32, // 75: api.BMProvider.GetResourceInfo:output_type -> api.GetResourceInfoResponse
	34, // 76: api.BMProvider.SetResourcePower:output_type -> api.SetResourcePowerResponse
	36, // 77: api.BMProvider.SetResourceBM2PXEBoot:output_type -> api.SetResourceBM2PXEBootResponse
	38, // 78: api.BMProvider.WhoAmI:output_type -> api.WhoAmIResponse
	41, // 79: api.BMProvider.ListBootSource:output_type -> api.ListBootSourceResponse
	44, // 80: api.BMProvider.ReclaimBMHost:output_type -> api.ReclaimBMResponse
	46, // 81: api.BMProvider.DeployMachine:output_type -> api.DeployMachineResponse
	57, // 82: api.VailbreakProxy.ValidateOpenstackIp:output_type -> api.ValidateOpenstackIpResponse
	59, // 83: api.VailbreakProxy.RevalidateCredentials:output_type -> api.RevalidateCredentialsResponse
	61, // 84: api.VailbreakProxy.UploadVDDK:output_type -> api.UploadVDDKResponse
