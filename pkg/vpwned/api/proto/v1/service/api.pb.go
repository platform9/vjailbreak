...
const file_sdk_proto_v1_api_proto_rawDesc = "" +
	...
	"\x12InjectEnvVariables\x12\x1e.api.InjectEnvVariablesRequest\x1a\x1f.api.InjectEnvVariablesResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/vpw/v1/inject_env_variablesB$\n" +
...
var file_sdk_proto_v1_api_proto_depIdxs = []int32{
	...
	62, // 43: api.Version.Cleanup:input_type -> api.CleanupRequest
	19, // 44: api.VCenter.ListVMs:input_type -> api.ListVMsRequest
	21, // 45: api.VCenter.GetVM:input_type -> api.GetVMRequest
	23, // 46: api.VCenter.ReclaimVM:input_type -> api.ReclaimVMRequest
	25, // 47: api.VCenter.CordonHost:input_type -> api.CordonHostRequest
	17, // 48: api.VCenter.UnCordonHost:input_type -> api.UnCordonHostRequest
	14, // 49: api.VCenter.ListHosts:input_type -> api.ListHostsRequest
	29, // 50: api.BMProvider.ListMachines:input_type -> api.BMListMachinesRequest
	31, // 51: api.BMProvider.GetResourceInfo:input_type -> api.GetResourceInfoRequest
	33, // 52: api.BMProvider.SetResourcePower:input_type -> api.SetResourcePowerRequest
	35, // 53: api.BMProvider.SetResourceBM2PXEBoot:input_type -> api.SetResourceBM2PXEBootRequest
	37, // 54: api.BMProvider.WhoAmI:input_type -> api.WhoAmIRequest
	40, // 55: api.BMProvider.ListBootSource:input_type -> api.ListBootSourceRequest
	43, // 56: api.BMProvider.ReclaimBMHost:input_type -> api.ReclaimBMRequest
	45, // 57: api.BMProvider.DeployMachine:input_type -> api.DeployMachineRequest
	56, // 58: api.VailbreakProxy.ValidateOpenstackIp:input_type -> api.ValidateOpenstackIpRequest
	58, // 59: api.VailbreakProxy.RevalidateCredentials:input_type -> api.RevalidateCredentialsRequest
	60, // 60: api.VailbreakProxy.InjectEnvVariables:input_type -> api.InjectEnvVariablesRequest
	4,  // 61: api.Version.Version:output_type -> api.VersionResponse
	9,  // 62: api.Version.InitiateUpgrade:output_type -> api.UpgradeResponse
	10, // 63: api.Version.GetUpgradeProgress:output_type -> api.UpgradeProgressResponse
	6,  // 64: api.Version.GetAvailableTags:output_type -> api.AvailableUpdatesResponse
	63, // 65: api.Version.Cleanup:output_type -> api.CleanupResponse
	...
	59, // 81: api.VailbreakProxy.RevalidateCredentials:output_type -> api.RevalidateCredentialsResponse
	61, // 82: api.VailbreakProxy.InjectEnvVariables:output_type -> api.InjectEnvVariablesResponse
