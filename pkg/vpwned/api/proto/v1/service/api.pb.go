...
const file_sdk_proto_v1_api_proto_rawDesc = "" +
	...
	"\x15RevalidateCredentials\x12!.api.RevalidateCredentialsRequest\x1a\".api.RevalidateCredentialsResponse\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/vpw/v1/revalidate_credentialsB$\n" +
...
var file_sdk_proto_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
...
var file_sdk_proto_v1_api_proto_depIdxs = []int32{
	...
	60, // 44: api.Version.CleanupStep:input_type -> api.CleanupStepRequest
	...
	9,  // 65: api.Version.ConfirmCleanupAndUpgrade:output_type -> api.UpgradeResponse
	61, // 66: api.Version.CleanupStep:output_type -> api.CleanupStepResponse
	20, // 67: api.VCenter.ListVMs:output_type -> api.ListVMsResponse
	22, // 68: api.VCenter.GetVM:output_type -> api.GetVMResponse
	24, // 69: api.VCenter.ReclaimVM:output_type -> api.ReclaimVMResponse
	26, // 70: api.VCenter.CordonHost:output_type -> api.CordonHostResponse
	18, // 71: api.VCenter.UnCordonHost:output_type -> api.UnCordonHostResponse
	15, // 72: api.VCenter.ListHosts:output_type -> api.ListHostsResponse
	30, // 73: api.BMProvider.ListMachines:output_type -> api.BMListMachinesResponse
	32, // 74: api.BMProvider.GetResourceInfo:output_type -> api.GetResourceInfoResponse
	34, // 75: api.BMProvider.SetResourcePower:output_type -> api.SetResourcePowerResponse
	36, // 76: api.BMProvider.SetResourceBM2PXEBoot:output_type -> api.SetResourceBM2PXEBootResponse
	38, // 77: api.BMProvider.WhoAmI:output_type -> api.WhoAmIResponse
	41, // 78: api.BMProvider.ListBootSource:output_type -> api.ListBootSourceResponse
	44, // 79: api.BMProvider.ReclaimBMHost:output_type -> api.ReclaimBMResponse
	46, // 80: api.BMProvider.DeployMachine:output_type -> api.DeployMachineResponse
	57, // 81: api.VailbreakProxy.ValidateOpenstackIp:output_type -> api.ValidateOpenstackIpResponse
	59, // 82: api.VailbreakProxy.RevalidateCredentials:output_type -> api.RevalidateCredentialsResponse
