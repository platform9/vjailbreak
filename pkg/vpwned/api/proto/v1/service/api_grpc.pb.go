...
const (
	...
	VailbreakProxy_UploadVDDK_FullMethodName            = "/api.VailbreakProxy/UploadVDDK"
)
...
type VailbreakProxyClient interface {
	...
	UploadVDDK(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadVDDKRequest, UploadVDDKResponse], error)
}
...
func (c *vailbreakProxyClient) UploadVDDK(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadVDDKRequest, UploadVDDKResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &VailbreakProxy_ServiceDesc.Streams[0], VailbreakProxy_UploadVDDK_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[UploadVDDKRequest, UploadVDDKResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type VailbreakProxy_UploadVDDKClient = grpc.ClientStreamingClient[UploadVDDKRequest, UploadVDDKResponse]
...
type VailbreakProxyServer interface {
	...
	UploadVDDK(grpc.ClientStreamingServer[UploadVDDKRequest, UploadVDDKResponse]) error
...
func (UnimplementedVailbreakProxyServer) UploadVDDK(grpc.ClientStreamingServer[UploadVDDKRequest, UploadVDDKResponse]) error {
	return status.Errorf(codes.Unimplemented, "method UploadVDDK not implemented")
}
...
func _VailbreakProxy_UploadVDDK_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(VailbreakProxyServer).UploadVDDK(&grpc.GenericServerStream[UploadVDDKRequest, UploadVDDKResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type VailbreakProxy_UploadVDDKServer = grpc.ClientStreamingServer[UploadVDDKRequest, UploadVDDKResponse]
...
var VailbreakProxy_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "UploadVDDK",
			Handler:       _VailbreakProxy_UploadVDDK_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "sdk/proto/v1/api.proto",
