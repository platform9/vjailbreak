...
func (UnimplementedVersionServer) ConfirmCleanupAndUpgrade(context.Context, *UpgradeRequest) (*UpgradeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmCleanupAndUpgrade not implemented")
}
func (UnimplementedVersionServer) CleanupStep(context.Context, *CleanupStepRequest) (*CleanupStepResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CleanupStep not implemented")
}
...
func (UnimplementedStorageArrayServer) CreateOrUpdateInitiatorGroup(context.Context, *CreateInitiatorGroupRequest) (*CreateInitiatorGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOrUpdateInitiatorGroup not implemented")
}
func (UnimplementedStorageArrayServer) MapVolumeToGroup(context.Context, *MapVolumeRequest) (*MapVolumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MapVolumeToGroup not implemented")
}
func (UnimplementedStorageArrayServer) UnmapVolumeFromGroup(context.Context, *UnmapVolumeRequest) (*UnmapVolumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnmapVolumeFromGroup not implemented")
}
func (UnimplementedStorageArrayServer) GetMappedGroups(context.Context, *GetMappedGroupsRequest) (*GetMappedGroupsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMappedGroups not implemented")
}
func (UnimplementedStorageArrayServer) ResolveCinderVolume(context.Context, *ResolveCinderVolumeRequest) (*ResolveCinderVolumeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResolveCinderVolume not implemented")
}
...
func RegisterStorageArrayServer(s grpc.ServiceRegistrar, srv StorageArrayServer) {
	// If the following call pancis, it indicates UnimplementedStorageArrayServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
