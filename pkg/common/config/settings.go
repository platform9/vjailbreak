...
func GetVjailbreakSettings(ctx context.Context, k8sClient client.Client) (*VjailbreakSettings, error) {
	...
	if vjailbreakSettingsCM.Data == nil {
		return &VjailbreakSettings{
			...
			LibguestfsMemsizeMB:                 constants.LibguestfsMemsizeMB,
		}, nil
	}
	...
	if vjailbreakSettingsCM.Data[constants.LibguestfsMemsizeMBKey] == "" {
		vjailbreakSettingsCM.Data[constants.LibguestfsMemsizeMBKey] = strconv.Itoa(constants.LibguestfsMemsizeMB)
	}
	...
	return &VjailbreakSettings{
		...
		LibguestfsMemsizeMB:                 Atoi(vjailbreakSettingsCM.Data[constants.LibguestfsMemsizeMBKey]),
	}, nil
}
