    ...
    html: |
      <div class="video-container">
        <div class="video-wrapper">
          <iframe
            src="https://www.youtube.com/watch?v=seThilJ5ujM"
...
<div class="download-section">
  <div class="download-content">
    ...
    <div class="command-box">
      <pre><code>oras pull quay.io/platform9/vjailbreak:v0.1.6</code></pre>
      <button class="copy-button" onclick="navigator.clipboard.writeText('oras pull quay.io/platform9/vjailbreak:v0.1.6')">
        Copy
      </button>
    </div>
