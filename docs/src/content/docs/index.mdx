...
<div class="download-section">
  <div class="download-content">
    ...
    <div class="command-box">
      <pre><code>oras pull quay.io/platform9/vjailbreak:v0.1.5</code></pre>
      <button class="copy-button" onclick="navigator.clipboard.writeText('oras pull quay.io/platform9/vjailbreak:v0.1.5')">
        Copy
      </button>
    </div>
